      ...
      <div id="top-bar">
        <div class="d-flex align-items-center justify-content-between gap-3">
          ...
          <div id="sign-up-in" class="d-flex align-items-center flex-shrink-1">
            <button id="sign-up" type="button" class="d-xl-flex d-lg-flex d-md-flex d-sm-none d-none">Đăng ký</button>
            <button id="sign-in" type="button" class="d-xl-flex d-lg-flex d-md-flex d-sm-none d-none">Đăng nhập</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <main id="main-view">
      <div class="container" style="max-width: 628px; margin: 0px auto; padding: 32px 16px">
        ...
        <p class="fs-4 text-white">
          <a href="" class="text-decoration-underline text-white">Đăng nhập</a>
              ...
              <div class="card mt-2" id="post_card">
                <div class="card-body" style="height: 100px; position: relative">
                  ...
                  <img
                    ...
                    class="card-img-top img_1" alt="..." style="
                        width: 50px;
                        position: absolute;
                        top: -10px;
                        left: 135px;
