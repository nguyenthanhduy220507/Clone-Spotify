    ...
    <div class="container mt-3 mb-5">
        ...
        <form id="form" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" list="users" name="user" value="<?php if (isset($data['playlist'])) echo $data['playlist']->getPlaylistUser()->getUserId(); ?>" id="user" placeholder="Select user">
                <datalist id="users">
                    <?php
    ...
    <script>
        $(document).ready(function() {
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    url: '?url=admin/auth_playlist_form/<?php echo $data['type'] ?>',
                    type: 'POST',
                    data: {
                        id: id,
                        name: name,
