    ...
    <main class="d-flex rounded-5">
        <section id="nav-side" class="d-flex gap-5 flex-column p-2">
            ...
            <nav id="nav-bar" class="my-3 my-scroll flex-grow-1 h-100" aria-labelledby="navigation sidebar">
                <ul class="list-unstyled d-flex flex-column justify-content-center align-items-center gap-5 m-0">
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Albums') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/albums">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-music-album"></i>
                            </div>
                            <span class="text-capitalize">albums</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Artists') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/artists">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-group"></i>
                            </div>
                            <span class="text-capitalize">artists</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Playlists') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/playlists">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-playlist"></i>
                            </div>
                            <span class="text-capitalize">playlists</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Songs') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/songs">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-music"></i>
                            </div>
                            <span class="text-capitalize">songs</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Song Listen History') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/song_listen_history">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-music"></i>
                            </div>
                            <span class="text-capitalize">history</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Song Playlist') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/song_playlist">
                            <div class="d-flex justify-content-center align-items-center">
                                <i class="niand-icon-music"></i>
                            </div>
                            <span class="text-capitalize">SP</span>
                        </a></li>
                    <li><a class="d-flex flex-column gap-2 <?php if($data['title'] == 'Users') echo 'active-nav';?> justify-content-center align-items-center text-decoration-none fs-6"
                            href="?url=admin/management/users">
                            <div class="d-flex justify-content-center align-items-center">
        ...
        <section id="main-content" class="d-flex flex-column flex-grow-1 p-2">
            <header class="d-flex mx-5 my-3 gap-3 justify-content-center align-items-center">
                <section>
                    <a class="d-flex gap-2 justify-content-center align-items-center text-decoration-none text-white"
                        href="">
                ...
                <nav class="flex-grow-1" aria-labelledby="navigation header">
                    <ul class="list-unstyled d-flex justify-content-center align-items-center gap-5 m-0">
                        ...
                        <li><a class="text-decoration-none text-uppercase active fw-medium" href="?url=admin/management/albums">management</a></li>
